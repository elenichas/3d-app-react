...
import { computeFaceNormal } from "./DimensionController.js";

class Info extends Dimension {
  constructor() {
    super();
    this.createGizmo = function (container) {
      this.dimensionGizmo = new DimensionGizmoInfo(this, container);
    ...
    this.getInfo = function () {
      var value = this.dimensionGizmo.getValue();
...
class DimensionGizmoInfo extends DimensionGizmo {
  constructor(dimension, container) {
    ...
    this.getValue = function () {
      ...
      var normal = this.selectedFace.normal
        .clone()
      ...
      var results = [
        {
          name: "Point",
          values: [controlPoints[0].x, controlPoints[0].y, controlPoints[0].z],
        },
        {
          name: "Face",
          values: [
            {
              name: "Point1",
              values: [facePoints[0].x, facePoints[0].y, facePoints[0].z],
            },
            {
              name: "Point2",
              values: [facePoints[1].x, facePoints[1].y, facePoints[1].z],
            },
            {
              name: "Point3",
              values: [facePoints[2].x, facePoints[2].y, facePoints[2].z],
            },
          ],
        },
